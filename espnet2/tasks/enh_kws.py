...
from espnet2.kws.espnet_joint_enh_kws_model import ESPnetEnhKWSModel
from espnet2.kws.frontend.magnitude2log_mel import Magnitude2LogmelFrontend
from espnet2.kws.frontend.magnitude2fbank import Magnitude2FbankFrontend

from espnet2.enh.nets.tf_mask_net_v1 import TFMaskingNet1
from espnet2.kws.encoder.conformer_encoder import ConformerEncoder
from espnet2.layers.global_mvn_v1 import GlobalMVN
from espnet2.train.trainer_v1 import Trainer
from espnet2.tasks.abs_task_enh_kws import AbsTask

enh_choices = ClassChoices(
    name="enh",
    classes=dict(tf_masking=TFMaskingNet, tf_masking1=TFMaskingNet1,tasnet=TasNet, wpe_beamformer=BeamformerNet),
