...
from espnet2.kws.preencoder.sinc import LightweightSincConvs
...
from espnet2.tasks.abs_task_kws import AbsTask
from espnet2.torch_utils.initialize import initialize
from espnet2.train.class_choices import ClassChoices
from espnet2.train.collate_fn import CommonCollateFn
from espnet2.train.preprocessor_kws import CommonPreprocessor
...
class KWSTask(AbsTask):
    ...
    @classmethod
    def build_model(cls, args: argparse.Namespace) -> ESPnetKWSModel:
        assert check_argument_types()
