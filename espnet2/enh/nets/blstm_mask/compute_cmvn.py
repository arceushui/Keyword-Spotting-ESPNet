...
from nets.blstm_mask.dataset import SpectrogramReader
from nets.blstm_mask.utils import nfft
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Command to compute global cmvn stats")
    parser.add_argument("--wave_scp", type=str, help="Location of mixture wave scripts")
    parser.add_argument("--cmvn_dst", type=str, help="Location to dump cmvn stats")
    parser.add_argument(
        "--frame-shift",
        type=int,
        default=256,
