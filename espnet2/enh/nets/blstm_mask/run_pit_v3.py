...
from nets.blstm_mask.trainer1 import PITrainer
from nets.blstm_mask.dataset1 import SpectrogramReader, Dataset, DataLoader1
...
def uttloader(scp_config, reader_kwargs, loader_kwargs, train=True):
    ...
    utt_loader = DataLoader1(dataset, **loader_kwargs)
    return utt_loader
